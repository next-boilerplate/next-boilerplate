...
exports.help = function () {
  return `
    ...
    If you have any problems, do not hesitate to file an issue:
      ${chalk.cyan('https://github.com/themodernjavascript/create-next-app-cli/issues/new')}
  `
}
...
exports.template = function () {
  return 'Initial templates default, bootstrap or material'
}
...
exports.start = function (projectName) {
  ...
  ${chalk.green('https://github.com/themodernjavascript/create-next-app-cli/issues')}
`
}
