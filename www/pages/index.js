      ...
      <div>
        ...
        <div className={classes.root}>
          <div>
            ...
            <Button href={'#install-create-next-app'} variant="contained" color="secondary" className={classes.button}>
              Get Started
            </Button>
          </div>
        </div>
        <div style={{ display: 'flex', margin: 40 }}>
          <Grid container spacing={24} direction="column">
            ...
            <Grid container item spacing={0} justify="center">
              <Grid item lg={6} xl={6} xs={12}>
                <Typography variant="body1" gutterBottom>
                  <a href="https://github.com/zeit/next.js" target="_blank">Next.js</a> is a framework for building server side rendering applications.
                </Typography>
              </Grid>
            </Grid>
            <Grid container item spacing={0} justify="center">
            ...
            <Grid container item spacing={0} justify="center" id="install-create-next-app">
              <Grid item lg={6} xl={6} xs={12}>
                <Typography variant="h4" gutterBottom>
